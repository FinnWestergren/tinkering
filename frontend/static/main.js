...
var $author$project$Main$BlogPost = F2(
	function (a, b) {
		return {$: 'BlogPost', a: a, b: b};
	});
var $author$project$Main$BlogPostMsg = function (a) {
	return {$: 'BlogPostMsg', a: a};
};
...
var $author$project$Pages$BlogPost$Loading = {$: 'Loading'};
var $author$project$Pages$BlogPost$PostRetrieved = function (a) {
	return {$: 'PostRetrieved', a: a};
};
...
var $author$project$Pages$BlogPost$testPostModel = function (id) {
	return {
		date: A3($justinmimbs$date$Date$fromCalendarDate, 2021, $elm$time$Time$Jan, 1),
		id: id,
		title: 'test_1'
	};
};
var $author$project$Pages$BlogPost$httpFetchPost = function (id) {
	var task = $elm$core$Process$sleep(100);
	var msg = $author$project$Pages$BlogPost$PostRetrieved(
		$author$project$Pages$BlogPost$testPostModel(id));
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return msg;
...
var $author$project$Pages$BlogPost$init = function (postId) {
	return _Utils_Tuple2(
		$author$project$Pages$BlogPost$Loading,
		$author$project$Pages$BlogPost$httpFetchPost(postId));
};
var $author$project$Pages$Home$LoadingPosts = {$: 'LoadingPosts'};
var $author$project$Pages$Home$PostsRetrieved = function (a) {
	return {$: 'PostsRetrieved', a: a};
};
var $author$project$Pages$Home$testHomeModel = _List_fromArray(
	[
		{
		date: A3($justinmimbs$date$Date$fromCalendarDate, 2021, $elm$time$Time$Jan, 1),
		id: 'kjnhdf19084',
...
var $author$project$Pages$Home$httpFetchPosts = function () {
	var task = $elm$core$Process$sleep(100);
	var msg = $author$project$Pages$Home$PostsRetrieved($author$project$Pages$Home$testHomeModel);
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return msg;
...
var $author$project$Pages$Home$init = _Utils_Tuple2($author$project$Pages$Home$LoadingPosts, $author$project$Pages$Home$httpFetchPosts);
var $elm$core$Platform$Cmd$map = _Platform_map;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$changePageTo = F2(
	function (model, route) {
		switch (route.$) {
			...
			case 'Home':
				var _v1 = $author$project$Pages$Home$init;
				var homeModel = _v1.a;
				var homeCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var id = route.a;
				var _v2 = $author$project$Pages$BlogPost$init(id);
				var postModel = _v2.a;
				var postCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: A2($author$project$Main$BlogPost, id, postModel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$BlogPostMsg, postCmd));
		}
	});
...
var $author$project$Main$init = F3(
	function (flags, url, navKey) {
		var defaultModel = {
			config: A2($elm$core$Debug$log, 'test2', flags),
			navKey: navKey,
			page: $author$project$Main$Redirect
		};
		var _v0 = A2(
			$author$project$Main$changePageTo,
			defaultModel,
...
var $author$project$Main$stepPost = F3(
	function (id, model, _v0) {
		var postModel = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
			...
			A2($elm$core$Platform$Cmd$map, $author$project$Main$BlogPostMsg, cmd));
	});
...
var $author$project$Pages$BlogPost$Loaded = function (a) {
	return {$: 'Loaded', a: a};
};
var $author$project$Pages$BlogPost$update = F2(
	function (msg, _v0) {
		var post = msg.a;
		return _Utils_Tuple2(
			$author$project$Pages$BlogPost$Loaded(post),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Home$PostsLoaded = function (a) {
	return {$: 'PostsLoaded', a: a};
};
var $author$project$Pages$Home$update = F2(
	function (msg, _v0) {
		if (msg.$ === 'FetchPosts') {
			return _Utils_Tuple2($author$project$Pages$Home$LoadingPosts, $author$project$Pages$Home$httpFetchPosts);
		} else {
			var list = msg.a;
			return _Utils_Tuple2(
				$author$project$Pages$Home$PostsLoaded(list),
				$elm$core$Platform$Cmd$none);
		}
	});
			...
			case 'HomeMsg':
				...
				if (_v2.$ === 'Home') {
					...
					return A2(
						...
						model,
						A2($author$project$Pages$Home$update, msg, homeModel));
				} else {
			...
			case 'BlogPostMsg':
				...
				if (_v3.$ === 'BlogPost') {
					...
					return A3(
						...
						id,
						model,
						A2($author$project$Pages$BlogPost$update, msg, postModel));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
...
var $author$project$Pages$BlogPost$renderPost = function (post) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(post.title)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$justinmimbs$date$Date$toIsoString(post.date))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$span,
				_List_Nil,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(post.id)
					]))
			]));
};
var $author$project$Pages$BlogPost$renderPostsSection = function (model) {
	if (model.$ === 'Loaded') {
		var post = model.a;
		return $author$project$Pages$BlogPost$renderPost(post);
	} else {
		return A2(
			$rtfeldman$elm_css$Html$Styled$span,
			_List_Nil,
...
var $author$project$Pages$BlogPost$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Pages$BlogPost$renderPostsSection(model)
			]));
};
...
var $author$project$Route$pathOf = function (route) {
	switch (route.$) {
		case 'Home':
			return '';
		case 'BlogPost':
...
var $author$project$Pages$Home$renderPost = function (post) {
	var path = $author$project$Route$pathOf(
		$author$project$Route$BlogPost(post.id));
	return A2(
...
var $author$project$Pages$Home$renderPostsSection = function (model) {
	if (model.$ === 'PostsLoaded') {
		var posts = model.a;
		return A2(
			$rtfeldman$elm_css$Html$Styled$ol,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Pages$Home$renderPost, posts));
	} else {
		return A2(
			$rtfeldman$elm_css$Html$Styled$span,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('LoadingPosts')
				]));
	}
};
var $author$project$Pages$Home$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Pages$Home$renderPostsSection(model)
			]));
};
var $author$project$Main$renderCurrentPage = function (model) {
	var _v0 = model.page;
	switch (_v0.$) {
		case 'Home':
			var homeModel = _v0.a;
			return $author$project$Pages$Home$view(homeModel);
		case 'BlogPost':
			var postModel = _v0.b;
			return $author$project$Pages$BlogPost$view(postModel);
		default:
...
var $author$project$Route$labelOf = function (route) {
	switch (route.$) {
		case 'Home':
			return 'Home';
		case 'BlogPost':
...
var $author$project$Main$viewLink = function (route) {
	var path = '/' + $author$project$Route$pathOf(route);
	var label = $author$project$Route$labelOf(route);
	return A2(
		$rtfeldman$elm_css$Html$Styled$li,
		_List_Nil,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$renderCurrentPage(model)
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'serverAddress', $elm$json$Json$Decode$string)))(0)}});}(this));